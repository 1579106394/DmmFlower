                    ...
                    <c:forEach items="${cart.flowerList}" var="flower" varStatus="index">
                        ...
                        <tr>
                            ...
                            <td class="td-manage">
                                ...
                                <a title="移出购物车" href="javascript:;" onclick="deleteFromCart('${flower.flowerId}', '${cart.cartId}')"
...
<script>
    ...
    /*移出购物车*/
    function deleteFromCart(flowerId, cartId) {
        layer.confirm('确认要移出购物车吗？', function (index) {
            window.location.href = "${pageContext.request.contextPath}/api/cart/deleteFromCart" + cartId + "/"+flowerId+".html"
        });
    }
