    ...
    <div class="page-content">
        <div class="content">
            ...
            <form class="layui-form layui-form-pane" action="${pageContext.request.contextPath}/api/order/addOrder.html"
                ...
                <c:forEach items="${cart.flowerList}" var="flower" varStatus="index">
                    <div class="layui-form-item">
                        <label for="${flower.flowerId}" class="layui-form-label">
                                ${flower.flowerName}
                        </label>
                        <div class="layui-input-inline">
                            <input type="hidden" name="flowerList[${index.index}].flowerId" value="${flower.flowerId}"/>
                            <input type="number" id="${flower.flowerId}" value="${flower.flowerNum}"
                                   name="flowerList[${index.index}].flowerNum" required=""
