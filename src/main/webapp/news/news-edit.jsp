    ...
    <div class="page-content">
        <div class="content">
            ...
            <form id="form" class="layui-form layui-form-pane"
                  action="${pageContext.request.contextPath}/api/news/editNews.html" method="post">
                <input type="hidden" name="staff.staffId" value="${sessionScope.staff.staffId}"/>
                <input type="hidden" name="newsId" value="${news.newsId}"/>
                <input type="hidden" name="newsReadNum" value="${news.newsReadNum}"/>
                <!-- 富文本编辑器内容 -->
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_news_name" name="newsTitle" value="${news.newsTitle}" required=""
