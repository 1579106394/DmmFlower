    ...
    <div class="page-content">
        <div class="content">
            ...
            <form id="form" class="layui-form layui-form-pane"
                  action="${pageContext.request.contextPath}/api/flower/addFlower.html" method="post" enctype="multipart/form-data">
                <input type="hidden" name="staff.staffId" value="${sessionScope.staff.staffId}"/>
                <!-- 富文本编辑器内容 -->
                <input type="hidden" name="flowerArticle" class="article"/>
                <div class="layui-form-item">
                    <label for="L_flower_name" class="layui-form-label">
                        花卉名
                    </label>
                    <div class="layui-input-inline">
                        <input type="text" id="L_flower_name" name="flowerName" required=""
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_flower_price" name="flowerPrice" required=""
                               autocomplete="off" class="layui-input">
                    </div>

                </div>
                <div class="layui-form-item">
                    <label for="L_flower_num" class="layui-form-label">
                        库存
                    </label>
                    <div class="layui-input-inline">
                        <input type="text" id="L_flower_num" name="flowerNum" required=""
                               autocomplete="off" class="layui-input">
                    </div>
