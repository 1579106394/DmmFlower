...
<div class="wrapper">
    ...
    <div class="page-content">
        <div class="content">
            ...
            <form id="logForm" class="layui-form xbs layui-form-pane"
                  action="${pageContext.request.contextPath}/api/log/logList.html" method="post">
            ...
            <table class="layui-table">
                ...
                <tbody>
                <form id="deleteForm" action="${pageContext.request.contextPath}/api/log/deleteLog.html"
                      method="post">
                    <c:forEach items="${page.list}" var="log" varStatus="index">

                        <tr>
                            <td><input type="checkbox" name="ids" value="${log.logId}">
                            </td>
                            <td>${index.index+1}</td>
                            <td>${log.logArticle}</td>
                            <td>${log.logCreatedTime}</td>
                            <c:if test="${sessionScope.staff.staffRole == 3}">
                                <td class="td-manage">

                                    <a title="删除" href="javascript:;" onclick="deleteLog('${log.logId}')"
...
<script>
    ...
    function deleteLog(id) {
        layer.confirm('确认要删除吗？', function (index) {
            window.location.href = "${pageContext.request.contextPath}/api/log/deleteLog" + id + ".html"
        });
    }
