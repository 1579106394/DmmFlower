 ...
 *   `history_id` varchar(36) NOT NULL COMMENT 'id为admin则是公司账户',
 *   `history_created_time` varchar(36) NOT NULL COMMENT '产生时间',
 *   `history_price` double(15,0) NOT NULL DEFAULT '0' COMMENT '多少钱 ',
 *   `history_action` varchar(100) NOT NULL COMMENT '用于做什么，进货？工资？',
